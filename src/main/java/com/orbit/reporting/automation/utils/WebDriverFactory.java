...
//						255);
//			}
			// Removed webDriver = new FirefoxDriver(ffProfile);
			webDriver = new FirefoxDriver();

		} else if (INTERNET_EXPLORER.equals(browser)) {
            //isSupportedPlatform(browser);
			String ieBinary = "src/main/resources/drivers/IEDriverServer/IEDriverServer/IEDriverServer.exe";
...
//			capability.setPlatform(Platform.ANDROID);
	...
	private static void setFirefoxDriver() {
		String os = System.getProperty("os.name").toLowerCase().substring(0, 3);
		String firefoxBinary = "src/main/resources/drivers/geckodriver/geckodriver"
				+ (os.equals("win") ? ".exe" : "");
